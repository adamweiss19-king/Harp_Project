...
4. User is able to add on additional notes.
5. Song is transcribed into all keys
6. User is provided with data on which keys best transcribed and can select which key to view the transcribed tabs for.
